...
exports.resetPasswordWithCode = exports.verifyResetCode = exports.sendResetCode = exports.checkEmailHealth = exports.onUserCreated = exports.sendWelcomeEmail = exports.sendAppointmentConfirmation = exports.sendPasswordResetEmail = void 0;
...
const getBrevoKey = () => {
    var _a;
    const key = ((_a = functions.config().brevo) === null || _a === void 0 ? void 0 : _a.key) || process.env.BREVO_API_KEY;
    if (!key) {
...
const sendEmail = async (to, template) => {
    var _a, _b, _c;
    try {
        const response = await axios_1.default.post(BREVO_API_URL, {
        ...
        console.error('Email send error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
        throw new Error(((_c = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) || 'Failed to send email');
    }
};
// ============================================================================
// CLOUD FUNCTIONS
...
exports.sendAppointmentConfirmation = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        // Also notify admin
        const adminTemplate = templates.adminNotification(Object.assign({ type: 'Appointment Booking' }, data));
...
const sendResetCodeEmail = async (email, code, name) => {
...
<body style="margin:0; padding:0; background:#f5f5f5; font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;">
    ...
    await axios_1.default.post(BREVO_API_URL, emailData, {
        headers: {
            'api-key': brevoKey,
            'Content-Type': 'application/json'
        }

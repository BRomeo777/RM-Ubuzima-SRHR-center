...
Write-Host "🚀 Deploying RM Ubuzima to HF Spaces..." -ForegroundColor Green
Write-Host ""
...
# Commit
git commit -m "Deploy RM Ubuzima - $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
...
Write-Host "🔗 URL: $SPACE_URL" -ForegroundColor Cyan
Write-Host "⏱️  Wait 1-2 minutes for build to complete" -ForegroundColor Yellow
Write-Host ""
